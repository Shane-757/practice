 ...
 *greater than 100. We want to find to get the average of all the numbers without all of the dirty data in our array.
...
var cleanData = function (arr) {
    const newNumbers = arr.filter(value => value >= 1 && value <= 100);
    

   const newTotals = newNumbers.reduce((previousValue, number) => {
        return previousValue + number
    }, 0);

 

return Math.floor(newTotals / newNumbers.length);
